  ...
  <div class="header">
    <div class="container-xl">
      <div class="row">
        ...
        <div class="col col-md-auto align-self-center d-none d-md-block">
        ...
        <div class="col-auto align-self-center d-none d-sm-block">
          <div class="header--contact-info">
            <div>
              ...
              <a class="link--email" href="mailto:office@assist.trust.co.uk">office@assist.trust.co.uk</a>
            </div>
                      ...
                      <?php if (!empty($item['children'])): ?>
                        ...
                        <ul class="sub-menu">
                          <?php foreach($item['children'] as $child): ?>
                            <li>
                              <a href="<?php echo $child['url']; ?>" title="<?php echo $child['title']; ?>"><?php echo $child['title']; ?></a>
                            </li>
                          <?php endforeach; ?>
                        </ul>
                      <?php else: ?>
